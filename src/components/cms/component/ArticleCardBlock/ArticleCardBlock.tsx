...
const BlogCard: React.FC<BlogCardProps> = ({ title, image }) => {
  ...
  return (
    <article className={`flex flex-col items-start p-4  ${Styles.articleCard}`}>
      <figure>
      ...
      <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/7d2cba332e26542d7c608ff2ca3ac131f182706497c134e46891f949818a1895?placeholderIfAbsent=true&apiKey=55a1f87f288a4c39862df294d0639360" alt="" className="mt-7 w-[92px]" />
