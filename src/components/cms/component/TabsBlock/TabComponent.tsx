  ...
  return (
    <>
      ...
      <p className="self-stretch mt-9 text-base leading-7 max-md:mr-2.5 max-md:max-w-full">
        Add colour and excitement to the interior of your windows. In addition,
        to the standard white colour, we have a black colour option with s
        finish technology Finishield™ <br />
        that stands up to scratches and heat degradation and maintains
        consistent colour. FiniShield™ is backed by a 10-Year Limited Warranty.
      </p>
      <p className="mt-9 text-base leading-loose max-md:max-w-full">
        Note: Colours shown online may vary from actual finishing due to
      ...
      <p className="mt-9 text-base leading-7 max-md:max-w-full">
        Add colour and excitement to your windows with a range of beautiful
        colours to accentuate your homes visual appeal and complement many
        popular trim and house paint <br />
        colours. Or let your imagination go wild and order custom painted
        windows in any colour you choose. Whichever colour you select, know that
        it will remain vivid and true year <br />
        after year.*Colours are subject to regional availability. Please contact
        your JELD-WEN dealer for more information.
      </p>
